...
import { Button, Checkbox, Container, FormControl, FormControlLabel, IconButton, InputLabel, MenuItem, OutlinedInput, Select, TextareaAutosize, TextField, Typography } from '@mui/material';
    ...
    return ( 
        <div>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={4}>
                    <Button variant="contained" type="submit" component="label"> Add Property</Button>
                </Grid>
            </Grid>
            </form>
            </Container>
